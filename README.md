# Predictive Analysis of the Rental Prices of Houses in Saudi Arabia
...
*Note: The plots were made using Plotly, but since GitHub does not support interactive plots they were rendered as static images.*
